...
class ColorPalette:
    def __init__(self):
        # 기본 변수 설정
        self.num_segments = 3000
        self.num_colors = 20  # 컬러팔레트의 컬러 개수
        ...
        # 전체 컬러팔레트에서 지방 인덱스 모음
        self.white_idx_list = []
        
        # 컬러팔레트 도출 시 이 색들과 유사한 색상 선택
        self.whites_list_select = [
            (245, 236, 233),
            (244, 233, 230),
            (225, 205, 202),
            (224, 201, 195),
        ...
        self.red_list_select = [
            (255, 0, 0)
        ]
        
        # 컬러팔레트 도출 시 빼야 하는 색상들
        self.white_exclude_color = [
            (137, 93, 93),
            (118, 63, 60),
            (140, 96, 97),
            (140, 96, 97)
        ]
        self.red_exclude_color = [
            (137, 93, 93),
            (118, 63, 60),
            (140, 96, 97),
            (140, 96, 97),
